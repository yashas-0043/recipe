        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center">
              ...
              <h3 className="ml-2 text-xl font-heading font-bold">CookBook</h3>
            </div>
            <p className="mt-4 text-gray-300">
              Discover delicious, easy-to-make recipes for every occasion.
            </p>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/?category=all">
                  <a className="text-gray-300 hover:text-white">Categories</a>
                </Link>
              </li>
              <li>
                <Link href="/">
                  <a className="text-gray-300 hover:text-white">Popular Recipes</a>
                </Link>
              </li>
              <li>
                <Link href="/">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/?category=2">
                  <a className="text-gray-300 hover:text-white">Breakfast</a>
                </Link>
              </li>
              <li>
                <Link href="/?category=3">
                  <a className="text-gray-300 hover:text-white">Lunch</a>
                </Link>
              </li>
              <li>
                <Link href="/?category=4">
                  <a className="text-gray-300 hover:text-white">Dinner</a>
                </Link>
              </li>
              <li>
                <Link href="/?category=5">
                  <a className="text-gray-300 hover:text-white">Desserts</a>
                </Link>
              </li>
              <li>
                <Link href="/?category=6">
                  <a className="text-gray-300 hover:text-white">Vegetarian</a>
                </Link>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a
                  href="mailto:hello@cookbook.com"
